 ...
 *     <code>org.apache.commons.logging.impl.AdapterLog</code>.</li>
 * </ul>
 * <p>
...
public class MyLogFactory extends LogFactory {
    ...
    private static final String LOGGING_IMPL_LOG4J_LOGGER = "org.apache.commons.logging.myLogger.Log4JLogger";
    /** Jdk14Logger class name */
    private static final String LOGGING_IMPL_JDK14_LOGGER = "org.apache.commons.logging.myLogger.Jdk14Logger";
    /** Jdk13LumberjackLogger class name */
    private static final String LOGGING_IMPL_LUMBERJACK_LOGGER =
            "org.apache.commons.logging.myLogger.Jdk13LumberjackLogger";

    /** AdapterLog class name */
    private static final String LOGGING_IMPL_SIMPLE_LOGGER = "org.apache.commons.logging.myLogger.AdapterLog";

    private static final String PKG_IMPL="org.apache.commons.logging.myLogger.";
    ...
    private static final String[] classesToDiscover = {
            ...
            "org.apache.commons.logging.myLogger.Jdk14Logger",
            "org.apache.commons.logging.myLogger.Jdk13LumberjackLogger",
            "org.apache.commons.logging.myLogger.AdapterLog"
    };
    ...
    private void initDiagnostics() {
        ...
        diagnosticPrefix = "[MyLogFactory@" + System.identityHashCode(this) + " from " + classLoaderName + "] ";
    }
    ...
    private Log discoverLogImplementation(String logCategory)
        ...
        // and AdapterLog will always work in any JVM. So the loop would never
    ...
    private ClassLoader getBaseClassLoader() throws LogConfigurationException {
        ClassLoader thisClassLoader = getClassLoader(MyLogFactory.class);
        ...
        if (baseClassLoader == null) {
           ...
           if (allowFlawedContext) {
            ...
            throw new LogConfigurationException("Bad classloader hierarchy; MyLogFactory was loaded via" +
            ...
            if (allowFlawedContext) {
                if (isDiagnosticsEnabled()) {
                    logDiagnostic(
                            ...
                            " classloader that loaded MyLogFactory; it should be" +
                ...
                throw new LogConfigurationException(
                        "Bad classloader hierarchy; MyLogFactory was loaded via" +
                        " a classloader that is not related to the current context" +
                        " classloader.");
            }
        }
